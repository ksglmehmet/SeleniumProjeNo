...
print(f"\nSayfada toplam: {len(Tiffs)} adet .tiff dosyası bulundu.")
print("Sayfada olan Tiff'ler:")
for tiff in Tiffs:
    print(f" - {tiff}")

for i in range(len(Tiffs) - 1):
    time.sleep(1)
    ...
    get_tiff = driver.find_element(By.XPATH, '/html/body/table/tbody/tr[2]/td/table/tbody/tr[1]/td/div/div[6]/div[2]').text
    
    print(f"\n{get_tiff} Belgesi İşleme Alınıyor...")
    ...
    try:
        ...
        print(f"\n{get_tiff} Belgesinin Kategori Bilgisi Zaten Mevcut !")
        a = ""  # Boş string atayarak devam et

    if a == 'No Categories for this Document.':
        time.sleep(1)
        print(f"{get_tiff} Belgesinin Kategori Bilgileri Dolduruluyor...")
        ...
        print(f"\n{get_tiff} Belgesinin Arşiv Bilgisi Ekleniyor...")
        time.sleep(2)
        ...
        print(f"\n{get_tiff} Belgesinin Proje Doküman Bilgisi Ekleniyor...")
        time.sleep(2)
