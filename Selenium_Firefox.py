...
time.sleep(1)
UserName = wait.until(EC.presence_of_element_located((By.XPATH, '//*[@id="otds_username"]')))
...
BirPage_ileri = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/table/tbody/tr[2]/td/table/tbody/tr[2]/td/table/tbody/tr/td/form[3]/div/div/div/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr/td/table/tbody/tr[1]/td[3]/div/table/tbody/tr/td[7]')))
BirPage_ileri.click()

time.sleep(2)

BirPage_geri = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/table/tbody/tr[2]/td/table/tbody/tr[2]/td/table/tbody/tr/td/form[3]/div/div/div/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr/td/table/tbody/tr[1]/td[3]/div/table/tbody/tr/td[1]')))
BirPage_geri.click()
...
if Total_items > 25:
    for i in range(1, (Total_page + 1)):
        driver.get(f"{ph.base_url}{i}_1__25_")
        time.sleep(2)
        Sayfadaki_Text = driver.find_element(By.XPATH, '//*[@id="browseViewCoreTable"]').text
        lines = Sayfadaki_Text.split("\n")
        for i in lines:
            if i.strip().endswith('.tiff'):
                # .tiff uzantısını kaldır ve boşlukları temizle
                proje_nos = i.strip().replace('.tiff', '')
                Tiffs.append(proje_nos)
        time.sleep(2)
    driver.get(f"{ph.base_url}1_1__25_")
# Yukarıdaki if'in else'sini yazmadım. 25 tiff den fazlası zaten olacak diye.

print(f"\n Toplam: {len(Tiffs)} Adet .tiff Dosyası Bulundu.")
 
# X İ DEĞİŞTİR: 
#Buraya sayfanın forunu koy
for x in range(3, (Total_page + 1)):
    time.sleep(2)
    wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/table/tbody/tr[2]/td/table/tbody/tr[2]/td/table/tbody/tr/td/form[3]/div/div/div/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr/td/table/tbody/tr[1]/td[3]/div/table/tbody/tr/td[7]'))).click()
    time.sleep(2)
    ...
    for i in range(0, len(page_count)):
        ...
        if a == 'No Categories for this Document.':
            time.sleep(1)
            print(f"{get_tiff} Proje Belgesinin Kategori Bilgileri Dolduruluyor...")
            ...
            print(f"{get_tiff} Proje Belgesinin Arşiv Bilgisi Ekleniyor...")
            time.sleep(2)
            ...
            print(f"{get_tiff} Proje Belgesinin Proje Doküman Bilgisi Ekleniyor...")
            time.sleep(2)
